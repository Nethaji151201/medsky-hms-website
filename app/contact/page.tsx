            ...
            <div className="bg-slate-900 text-white rounded-3xl p-8 border border-slate-800 shadow-xl space-y-8">
              ...
              <div className="space-y-6 text-sm">
                <div className="flex items-start gap-3.5">
                  <div className="w-10 h-10 rounded-xl bg-cyan-500/20 text-primary flex items-center justify-center flex-shrink-0 mt-0.5">
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-primary text-xs font-semibold mt-1.5">Emergency 24/7 Technical Support</p>
                  </div>
                </div>
              </div>
            </div>
